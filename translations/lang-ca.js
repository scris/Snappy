...
SnapTranslator.dict.ca = {
    ...
    'language_name': 'Català', // the name as it should appear in the language menu
    'language_translator': 'Bernat Romagosa Carrasquer, Joan Guillén i Pelegay', // your name for the Translators tab
    'translator_e-mail': 'bernat@arduino.org, jguille2@xtec.cat', // optional
    'last_changed': '2017-01-09', // this, too, will appear in the Translators tab
...
//Developer mode menus
    ...
    '\nalpha\nvalue:': '\nvalor del\ncanal alfa:',
    'set this morph\'s\nalpha value': 'fixeu el valor del canal\nalfa per aquest \'morph\'',
    'resize...': 'redimensiona...',
    ...
    'attach...': 'enganxa...',
    'stick this morph\nto another one': 'enganxa aquest \'morph\' a un altre',
    'move...': 'mou...',
    ...
    'World...': 'Món...',
    'show the\nWorld\'s menu': 'mostra el menú del Món',
    //World options
    'demo...': 'exemple...',
    ...
    'choose the World\'s\nbackground color': 'tria el color de\nfons del Món',
    'touch screen settings': 'configuració per pantalla tàctil',
    'bigger menu fonts\nand sliders': 'fa més grans els lliscadors i els menús',
    'standard settings': 'configuració estàndard',
    'smaller menu fonts\nand sliders': 'fa més petits els lliscadors i els menús',
...
//future JS options
    ...
    'JavaScript is not enabled': 'l\'execució de Javascript està deshabilitada',
...
//Libraries
    ...
    'Multi-branched conditional (switch)': 'Condicionals compostos (switch)',
    'LEAP Motion controller': 'Controladors per a LEAP Motion',
    'Set RGB or HSV pen color': 'Acoloriment del llapis per RGB o HSV',
    'Save and restore pictures drawn by pen': 'Gestió de les captures d\'imatges dibuixades',
    'Catch errors in a script': 'Alternatives per les errades dels programes',
    'Allow multi-line text input to a block': 'Entrades multilínia',
//
