...
SyntaxElementMorph.prototype.refactorVarInStack = function (oldName,
                                                            newName,
                                                            isScriptVar) {
...
SyntaxElementMorph.prototype.setLabelColor = function (textColor,
                                                       shadowColor,
                                                       shadowOffset) {
    this.children.forEach(function (morph) {
...
SyntaxElementMorph.prototype.fixBlockColor = function (nearestBlock,
                                                       isForced) {
    this.children.forEach(function (morph) {
...
CommandBlockMorph.prototype.wrapAttachPoint = function () {
    var cslot = detect( // could be a method making uses of caching...
        ...
        function (each) {
            return each instanceof CSlotMorph;
        }
    );
...
InputSlotMorph.prototype.init = function (text,
                                          isNumeric,
                                          choiceDict,
                                          isReadOnly) {
...
TextSlotMorph.prototype.init = function (text,
                                         isNumeric,
                                         choiceDict,
                                         isReadOnly) {
...
SymbolMorph.prototype.drawSymbolSpeechBubbleOutline = function (canvas,
                                                                color) {
    // answer a canvas showing a speech bubble
    var ctx = canvas.getContext('2d'),
        w = canvas.width,
...
function MultiArgMorph(slotSpec,
                       labelTxt,
                       min,
                       eSpec,
                       arrowColor,
...
MultiArgMorph.prototype.init = function (slotSpec,
                                         labelTxt,
                                         min,
                                         eSpec,
                                         arrowColor,
...
MultiArgMorph.prototype.setLabelColor = function (textColor,
                                                  shadowColor,
                                                  shadowOffset) {
...
ArgLabelMorph.prototype.setLabelColor = function (textColor,
                                                  shadowColor,
                                                  shadowOffset) {
    if (this.labelText !== '') {
        var label = this.label();
...
ScriptFocusMorph.prototype.init = function (editor,
                                            initialElement,
                                            position) {
